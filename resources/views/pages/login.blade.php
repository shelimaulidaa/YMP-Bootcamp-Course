...
<div class="min-h-screen flex mt-10">
    ...
    <div class="rounded-l-2xl w-3/6 h-[500px] flex flex-col justify-center items-center px-10 bg-white">
        ...
        <form action="{{ route('login.post') }}" method="POST" class="w-full max-w-sm space-y-4">
            ...
            <!-- Input tersembunyi untuk reCAPTCHA -->
            ...
            <div class="flex justify-between items-center text-sm text-gray-600">
                ...
                <a href="https://wa.me/6282119205610" target="_blank" class="hover:underline text-yellow-600">Lupa password?</a>
            </div>
        ...
        <script>
            grecaptcha.ready(function() {
                ...
                .then(function(token) {
                    // Pastikan elemen input ada sebelum diisi
    ...
    <!-- Bagian kanan -->
    <div class="rounded-r-2xl w-3/6 h-[500px] bg-cover bg-center relative" 
